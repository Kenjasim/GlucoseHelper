...
import com.kenjasim.glucosehelper.LoginActivity;
...
public class SettingsFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        remove = (Button) getView().findViewById(R.id.Delete);
        signOut = (Button) getView().findViewById(R.id.sign_out);
        asTV = (TextView) getView().findViewById(R.id.asTV);
    ...
    public void onStart() {
        SettingsFragment.super.onStart();
        auth.addAuthStateListener(authListener);
    }

    public void onStop() {
        SettingsFragment.super.onStop();
